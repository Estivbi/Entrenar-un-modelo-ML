# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 17:58:15 2024
...
dataframe = pd.read_csv('iris.data.csv', header=None, names=['longitud_sepalo', 'ancho_sepalo', 'longitud_petalo', 'ancho_petalo', 'especies'])
